...
const WarningPopup = ({ message, onConfirm, onCancel }) => {
  return (
    <div className="fixed top-5 right-5 z-50 flex flex-col gap-3 min-w-[320px] max-w-md p-5 rounded-xl border backdrop-blur-md shadow-lg animate-slide-in bg-red-50/90 border-red-200 text-red-900">
      {/* Header Section */}
